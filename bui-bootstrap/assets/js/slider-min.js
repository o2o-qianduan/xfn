define("bui/slider", ["bui/slider/slider"], function(e) {
	var t = BUI.namespace("Slider");
	return BUI.mix(t, {
		Slider: e("bui/slider/slider")
	}), t
}), define("bui/slider/slider", ["bui/common"], function(e) {
	"use strict";
		...
		l = n.Component.View.extend({
			...
			setRange: function(e, t, n) {
				...
				var r = this,
					...
					h = {},
					p = {};
				i && (h[f] = a + "%", h[l] = e + "%", i[c](h)), u === 1 ? (p[l] = d(t), o[c](p)) : u === 2 && (p[l] = d(e), o[0].style[l] !== p[l] && $(o[0])[c](p), p[l] = d(t), o[1].style[l] !== p[l] && $(o[1])[c](p))
			},
		...
		c = n.Component.Controller.extend({
			...
			_slideByOffset: function(e, t) {
				var r = this,
					i = r.get("value"),
					s = r._formatValue(e);
				if (i === s || n.isArray(s) && n.Array.equals(s, i)) return;
				t ? r.set("value", s) : (r.setInternal("value", s), r._setValue(s, !1))
			},
			_handleDrag: function(e) {
				...
				function f(e) {
					e.which == 1 && (n.set("draging", !1), a())
				}
				var n = this,
					r = n.get("isVertical"),
					i = $(e.target),
					s = i.position();
				e.which == 1 && (n.set("draging", {
					elX: s.left,
			...
			_getCalcValue: function(e) {
				var t = this,
					...
					a, l;
				o ? a = f(n.height() - e.top, u) : a = f(e.left, u), l = (r - i) * a / 100 + i;
				if (s) {
					l = parseInt(l, 10);
					var c = l % s;
					c && (l += s - c)
